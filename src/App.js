...
function App() {
  ...
  let controls = {
    ...
    misiurewiczParameters: useState(false),
    maxI: useState(250),
    aa: useState(false),
    dpr: useState(false),
    fps: useState(false),
  ...
  let settings = [{
    ...
    items: {
      ...
      misiurewiczParameters: {
        name: 'Display Misiurewicz parameters', 
        ctrl: <Switch 
          color="primary"
          checked={controls.misiurewiczParameters[0]} 
          onChange={() => toggleVal(controls.misiurewiczParameters)} 
        />
      },
    }
  }, {
      ...
      >
        ...
        <Grid item xs className="renderer">
          <MandelbrotRenderer
            ...
            misiurewiczParameters={controls.misiurewiczParameters[0]}
            aa={controls.aa[0]}
            dpr={dpr}
